...
NodeGradients = _reflection.GeneratedProtocolMessageType('NodeGradients', (_message.Message,), dict(
...
VariableWeightsReqResp = _reflection.GeneratedProtocolMessageType('VariableWeightsReqResp', (_message.Message,), dict(
